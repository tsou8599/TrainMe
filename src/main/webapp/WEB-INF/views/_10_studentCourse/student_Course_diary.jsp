		...
		<div class="content">
		 <div class="back">
			...
			<div class="setting_area">
					...
					<div class="setting_box" style="border:none;">
					...
					<div class="setting_box" style="border:none;">
						<label><h5>教練建議</h5></label>
							<div class="datdiary_content">${CourseMsg.datdiary_content}</div>
					</div>
				...
				.ready(
						function() {
									...
									.click(
											function() {
												...
												var index = $(
														...
														.index();
												var row = '<tr>'
														+ '<td><input style="width:85px;" type="text" class="form-control" name="name" id="name"></td>'
														+ '<td><input  style="width:86px;" type="text" class="form-control" name="department" id="department"></td>'
														+ '<td><input  style="width:86px;" type="text" class="form-control" name="phone" id="phone"></td>'
														+ '<td><input  style="width:86px;" type="text" class="form-control" name="phone" id="phone"></td>'
														+ '<td><input  style="width:86px;" type="text" class="form-control" name="phone" id="phone"></td>'
														+ '<td>' + actions
														+ '</td>' + '</tr>';
							...
							$(document).on("click",".edit",
											function() {$(this).parents("tr").find("td:not(:last-child)").each(
																function() {$(this).html('<input type="text" style="width:86px;" class="form-control" value="'+ $(this).text()+ '">');
																});
												$(this).parents("tr").find(
														".add, .edit").toggle();
